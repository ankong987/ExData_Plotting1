...
#setting the parameters to show 4 tables 2 by 2
par(mar=c(5, 5,1,1), mfrow = c(2,2))

#creating the first plot diagram from plot2
plot(power$Date, power$Global_active_power, type = 'l', 
     xlab= "",ylab = "Global Active Power")

#creating the second plot diagram 
...
#creating a plot diagram for reactive power
plot(power$Date, power$Global_reactive_power, type = 'l', 
